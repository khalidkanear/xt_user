...
import 'package:xtreamgynlogin/Views/Dashboard/Health/editPages/WeightEditPage.dart';

class weight extends StatefulWidget {
  const weight({Key? key}) : super(key: key);

  @override
  State<weight> createState() => _exercisePageState();
}

class _exercisePageState extends State<weight> {
        ...
        actions: [
          Container(
            ...
            child: IconButton(
              ...
              onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>weightEditPage()));
              },
            ),
          ),
        ],
