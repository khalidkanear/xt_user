...
import 'package:xtreamgynlogin/Views/Dashboard/Health/editPages/FoodEditPage.dart';

class foodPage extends StatefulWidget {
  const foodPage({Key? key}) : super(key: key);

  @override
  State<foodPage> createState() => _exercisePageState();
}

class _exercisePageState extends State<foodPage> {
        ...
        actions: [
          Container(
            ...
            child: IconButton(
              ...
              onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (context)=>foodEditPage()));
              },
            ),
          ),
        ],
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Text("we help you switch to a healthier, beneficial diet by allowing\n"
                      "you to monitor your daily, weekly, monthly, yearly\n"
                      "food intake. Find how many calories, proteins, and\n"
                      "carbohydrates etc. you consume and make a diet plan\n"
                      "accordingly.",
                    style: TextStyle(
                        color: AppColors.BackGround.withOpacity(0.7),
                        fontFamily: "Poppins",
