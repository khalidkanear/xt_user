...
class heartRateEdit extends StatefulWidget {
  const heartRateEdit({Key? key}) : super(key: key);

  @override
  State<heartRateEdit> createState() => _exercisePageState();
}

class _exercisePageState extends State<heartRateEdit> {
