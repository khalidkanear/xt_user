...
class weightEditPage extends StatefulWidget {
  const weightEditPage({Key? key}) : super(key: key);

  @override
  State<weightEditPage> createState() => _exercisePageState();
}

class _exercisePageState extends State<weightEditPage> {
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Container(
                      margin: EdgeInsets.fromLTRB(width*0.32, 0, 0, 0),
                      child: Text("Units",
                        style: TextStyle(
                          color: AppColors.BackGround.withOpacity(0.1),
                          fontSize: 14,
